...
export const Form = {
    // In D365 Form '<%= formname %>' specify Form onLoad function: <%= publisher %>.<%= namespace %>.<%= entity %>_Entity.Form.onLoad
...
export const Ribbon = {
    // In Ribbon WorkBench specify function: <%= publisher %>.<%= namespace %>.<%= entity %>_Entity.Ribbon.myRibbonMethod1
    ...
    // In Ribbon WorkBench specify function: <%= publisher %>.<%= namespace %>.<%= entity %>_Entity.Ribbon.myRibbonMethod2
